...
### Blockchain & Web3
- [Blockchain Integration](Blockchain_Integration.md) - Web3 features, wallet integration, and NFT asset management
- [In-Game Currency Rewards](In_Game_Currency_Rewards.md) - Non-blockchain economy and account-bound rewards

### Monetization
- [Monetization Schemas](Monetization_Schemas.md) - Booster pack revenue model and pricing strategy
- [Monetization Anti-Patterns](Monetization_AntiPatterns.md) - What NOT to do in monetization
...
### Network
- **Primary Network**: Avalanche C-Chain (AVAX)
...
- **Integration**: WEB3S plugin embedded in game client
- **Cloud Backup**: PlayFab integration for account recovery
- **Verification**: Crypto signature verification for asset ownership
