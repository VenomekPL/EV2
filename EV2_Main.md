...
- Processor: Intel Core i5-4790 (3.6 GHz)
- Memory: 8 GB RAM
...
- Memory: 16 GB RAM
- Graphics: NVIDIA GTX 1060/RTX 2060 or AMD RX 480
- Storage: 13 GB
- Network: Broadband Internet
- Sound: DirectX 11

*Note: Specifications may change due to ongoing optimization.*

---

## Content Rating

**Mature Content**: Shooting, Violence, Fighting
...
- [Monetization Schemas](Monetization_Schemas.md)
...
This is your starting point for the EV2 documentation. Explore the following sections:

- [Blockchain_Integration](Blockchain_Integration.md) - Web3 features, wallet integration, and NFT asset management
- [In-Game_Currency_Rewards](In-Game_Currency_Rewards.md) - Non-blockchain economy and account-bound rewards
- [Monetization_Schemas](Monetization_Schemas.md) - Booster pack revenue model and pricing strategy
- [Third_Party_Integration](Third_Party_Integration.md) - Cross-game NFT partnerships and cosmetic licensing
- [Monetization Systems](Monetization Systems.md) - Economic overview and sustainability
- [Game Features](Game Features.md) - Detailed gameplay mechanics
- [Characters & Progression](Characters & Progression.md) - Pilot development and advancement
- [Loot & Gear](Loot & Gear.md) - Equipment systems and customization

---

## Additional Resources

- Steam Store Page: [EV2 on Steam](https://store.steampowered.com/app/2606880/EV2/)
- Funtico Website: [funtico.com](https://funtico.com/)
- Official Discord: [Join Community](https://discord.com/invite/kN4kAAHvQd)

---

---

*This documentation has been moved to [README.md](README.md) for GitHub repository compatibility.*

*Please use [README.md](README.md) as the main entry point.*
